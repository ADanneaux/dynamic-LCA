...
def plot_carbon_decay(building_type,f_C, f_C_Carb_notdivided, f_C_G_notdivided, f_C_G_credit_notdivided, f_C_RG_credit_notdivided, t_TOD):
    ...
    fig.add_trace(go.Scatter(x=t_TOD, y=1e-6*f_C_RG_credit_notdivided[:len(t_TOD)], mode='lines', name='End-of-life substitution biogenic', line=dict(color='rgba(97, 167, 225, 0.99)', dash='dot', width=marker_line_width), fill='tozeroy',  fillcolor='rgba(97, 167, 225, 0.3)', showlegend=False))
