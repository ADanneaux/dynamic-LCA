...
# Data for traces
traces = [
    {'name': 'BAU-C1', 'x': x + x_rev, 'y': BAU_C1_025_max + BAU_C1_10_min, 'fillcolor': BAU_C1_color_f,
     'line_color': BAU_C1_color_l},
    {'name': 'BAU-C2', 'x': x + x_rev, 'y': BAU_C2_025_max + BAU_C2_10_min, 'fillcolor': BAU_C2_color_f,
     'line_color': BAU_C2_color_l},
    {'name': 'BAU-C3', 'x': x + x_rev, 'y': BAU_C3_025_max + BAU_C3_10_min, 'fillcolor': BAU_C3_color_f,
     'line_color': BAU_C3_color_l},
    {'name': 'LC<sup>3</sup>-C1', 'x': x + x_rev, 'y': LC3_C1_025_max + LC3_C1_10_min, 'fillcolor': LC3_C1_color_f,
     'line_color': LC3_C1_color_l},
    {'name': 'LC<sup>3</sup>-C2', 'x': x + x_rev, 'y': LC3_C2_025_max + LC3_C2_10_min, 'fillcolor': LC3_C2_color_f,
     'line_color': LC3_C2_color_l},
    {'name': 'LC<sup>3</sup>-C3', 'x': x + x_rev, 'y': LC3_C3_025_max + LC3_C3_10_min, 'fillcolor': LC3_C3_color_f,
     'line_color': LC3_C3_color_l},
    {'name': 'EST-T1', 'x': x + x_rev, 'y': EST_T1_025_max + EST_T1_10_min, 'fillcolor': EST_T1_color_f,
     'line_color': EST_T1_color_l},
    {'name': 'EST-T2', 'x': x + x_rev, 'y': EST_T2_025_max + EST_T2_10_min, 'fillcolor': EST_T2_color_f,
     'line_color': EST_T2_color_l},
    {'name': 'EST-T3', 'x': x + x_rev, 'y': EST_T3_025_max + EST_T3_10_min, 'fillcolor': EST_T3_color_f,
     'line_color': EST_T3_color_l},
    {'name': 'EST-T4', 'x': x + x_rev, 'y': EST_T4_025_max + EST_T4_10_min, 'fillcolor': EST_T4_color_f,
     'line_color': EST_T4_color_l},
    {'name': 'EST-T5', 'x': x + x_rev, 'y': EST_T5_025_max + EST_T5_10_min, 'fillcolor': EST_T5_color_f,
     'line_color': EST_T5_color_l},
    {'name': 'EST-T6', 'x': x + x_rev, 'y': EST_T6_025_max + EST_T6_10_min, 'fillcolor': EST_T6_color_f,
     'line_color': EST_T6_color_l},
    {'name': 'EST-T7', 'x': x + x_rev, 'y': EST_T7_025_max + EST_T7_10_min, 'fillcolor': EST_T7_color_f,
...
directory = "../figures/agtp/html"
if not os.path.exists(directory):
    os.makedirs(directory)

directory = "../figures/agtp/img"
if not os.path.exists(directory):
    os.makedirs(directory)

# Save the figure as an HTML file
fig.write_html("../figures/agtp/html/agtp.html")

# Save the figure as an HTML file
fig.write_image("../figures/agtp/img/agtp.jpg", scale=scale, engine='orca')
