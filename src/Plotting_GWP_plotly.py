...
df = pd.read_csv(r'C:\Users\ay222\Desktop\20240715-dlca\dlca-methods-v14\output\GWP_Results.csv', index_col=0)
...
directory = "../figures/gwp/html"
if not os.path.exists(directory):
    os.makedirs(directory)

directory = "../figures/gwp/img"
if not os.path.exists(directory):
    os.makedirs(directory)

# Save the figure as an HTML file
fig.write_html("../figures/gwp/html/gwp100.html")

# Save the figure as an HTML file
fig.write_image("../figures/gwp/img/gwp100.jpg", scale=scale, engine='orca')
...
# Save the figure as an HTML file
fig.write_html("../figures/gwp/html/gwp200.html")

# Save the figure as an HTML file
fig.write_image("../figures/gwp/img/gwp200.jpg", scale=scale, engine='orca')
