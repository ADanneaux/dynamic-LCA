...
This repository contains the dynamic life cycle assessment (LCA) codebase and input data in the paper 'Mitigating hidden climate change impacts of timber cities critically depends on proactive forest and waste management'.
